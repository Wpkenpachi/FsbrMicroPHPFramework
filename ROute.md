...
PS2: Tenha como branch, cada item do array.<br>
    ...
    Subcomparações:
1. _Existem ainda duas subcomparações aqui nessa fase_:<br>

2. _Essas comparações são em cascata, se uma for verdadeira, o algoritmo verifica a proxima_
    

    - Comparação de quantidade de branches
    - comparação branch a branch (Pra saber se rota_salva[0] == url_browser[0])
